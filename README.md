...
```
tanzu apps workload create dotnet-app-19 -f config/workload.yaml \
  --local-path . \
  --source-image <REPOSITORY-PREFIX>/dotnet-app-19-source \
  --type web
```
...
```
tanzu apps workload get dotnet-app-19
```
