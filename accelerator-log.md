...
```json
{
  "applicationName" : "sampleapp10",
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=kadourah&repo=dotnetappe10",
  "projectName" : "dotnet-app-19"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->sampleapp10]
...
┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'sampleapp10.csproj'
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app->dotnet-app-19]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=kadourah&repo=dotnetappe10'
